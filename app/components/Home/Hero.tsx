...
export default function Hero({ companyName }: HeroProps) {
  const images = [
  ...
  return (
    <section
      className="animate-fade-in relative min-h-[560px] overflow-hidden sm:min-h-[600px] lg:min-h-[640px]"
    >
